...
REG ADD "HKCU\SOFTWARE\Classes\APK-Info.apk\DefaultIcon" /ve /t REG_SZ /d "\"%cd%\APK-Info_x64.exe\"" /f >nul 2>nul || SET "ERROR=1" >nul 2>nul
REG ADD "HKCU\SOFTWARE\Classes\APK-Info.apk\shell\open" /ve /t REG_SZ /d "APK-Info" /f >nul 2>nul || SET "ERROR=1" >nul 2>nul
REG ADD "HKCU\SOFTWARE\Classes\APK-Info.apk\shell\open\command" /ve /t REG_SZ /d "\"%cd%\APK-Info_x64.exe\" \"%%1\"" /f >nul 2>nul || SET "ERROR=1" >nul 2>nul

REG ADD "HKCU\SOFTWARE\Classes\SystemFileAssociations\.apk\Shell\APK-Info\Command" /ve /t REG_SZ /d "\"%cd%\APK-Info_x64.exe\" \"%%1\"" /f >nul 2>nul || SET "ERROR=1" >nul 2>nul
...
REG ADD "HKCU\SOFTWARE\Classes\APK-Info.apks\shell\open\command" /ve /t REG_SZ /d "\"%cd%\APK-Info_x64.exe\" \"%%1\"" /f >nul 2>nul || SET "ERROR=1" >nul 2>nul

REG ADD "HKCU\SOFTWARE\Classes\SystemFileAssociations\.apks\Shell\APK-Info\Command" /ve /t REG_SZ /d "\"%cd%\APK-Info_x64.exe\" \"%%1\"" /f >nul 2>nul || SET "ERROR=1" >nul 2>nul
